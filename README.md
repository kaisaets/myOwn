...
public class Main {
    public static void main(String[] args) {
        ...
        String userInputLowerCase = userInput.toLowerCase(); // Convert user input to lowercase

        boolean isInvited = false;
        for (String name : partyList) {
            if (name.toLowerCase().equals(userInputLowerCase)) {
                isInvited = true;
                break;
            }
        }
        ...
        if (isInvited) {
            System.out.println(userInput + " is in the party list");
        } else {
            System.out.println(userInput + " is not in the party list");
        }
